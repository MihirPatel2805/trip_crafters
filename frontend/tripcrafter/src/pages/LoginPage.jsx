...
const LoginPage = () => {
    ...
    return (
        <div className="main-div flex justify-center items-center min-h-screen">
            <div className="relative w-full max-w-5xl"> {/* Increased the width of the carousel */}
                {/* Carousel Wrapper */}
                <div className="relative overflow-hidden rounded-lg h-[500px] md:h-[600px]"> {/* Increased height */}
                ...
                <button
                    type="button"
                    className="absolute top-1/2 left-2 transform -translate-y-1/2 z-30 flex items-center justify-center w-10 h-10 bg-white/50 hover:bg-white/70 focus:outline-none"
                    onClick={prevSlide}
                >
                ...
                <button
                    type="button"
                    className="absolute top-1/2 right-2 transform -translate-y-1/2 z-30 flex items-center justify-center w-10 h-10 bg-white/50 hover:bg-white/70 focus:outline-none"
                    onClick={nextSlide}
                >
                ...
                <div className="absolute inset-0 flex justify-center items-center">
                    <div className="bg-white bg-opacity-20 w-96 p-8 rounded-lg shadow-lg"> {/* Increased form width */}
                        <form className="ml-2">
                            <h1 className="text-center text-3xl mb-8">{isSignUp ? 'SIGN UP' : 'LOGIN'}</h1>
                            ...
                            <div className="text-center text-sm text-black">
                                {isSignUp ? (
                                    <p>
                                        ...
                                        <a href="#" onClick={toggleForm} className="underline font-bold">
                                            Login
                                        </a>
                                    </p>
                                ) : (
